...
fn bezier_value_at(controlPoints: array<vec3f, 5>, t: f32) -> vec3f {
    var n = 5. - 1.;
    ...
    sum += bernstein_polynomial(4., n, t) * controlPoints[4];
    return sum;
}

fn bezier_slope_at(controlPoints: array<vec3f, 5>, t: f32) -> vec3f {
    var  n         = 5. - 1.;
    var  nMinusOne = n - 1.;
    ...
    sum += (controlPoints[3 + 1] - controlPoints[3]) * bernstein_polynomial(3., nMinusOne, t);
    return n * sum;
}
